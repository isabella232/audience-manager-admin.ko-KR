---
description: 날짜별로 Audience Manager 관리 안내서에 대한 모든 업데이트(추가, 삭제 및 수정 사항)
seo-description: 날짜별로 Audience Manager 관리 안내서에 대한 모든 업데이트(추가, 삭제 및 수정 사항)
seo-title: 설명서 업데이트
title: 설명서 업데이트
...
날짜별로 Audience Manager 관리 안내서에 대한 모든 업데이트(추가, 삭제 및 수정 사항)

기능 릴리스, 개선 사항 및 버그 수정에 대한 자세한 내용은 Experience Cloud [릴리스 정보를 참조하십시오](https://marketing.adobe.com/resources/help/en_US/whatsnew/). 이전 [Experience Cloud](https://marketing.adobe.com/resources/help/en_US/whatsnew/c_legacy_releases.html) 공지 사항에 대해서는 이전 릴리스 노트를 참조하십시오. 설명서 [!DNL Audience Manager documentation changes, see] 업데이트를 [참조하십시오](https://docs.adobe.com/content/help/en/audience-manager/user-guide/documentation-updates/docs-2019.html).
...
| 주제 | 설명 |
---------|----------|
| HTTP 형식 매크로 | 새 매크로와 `REGION_ID_LIST`세 개의 새 필드,`sda``sda`및 `sda` 새 `USER_LIST` 매크로를 추가했습니다. |
| HTTP 형식 매크로 | 두 개의 새 매크로를 추가했습니다. `ECID` 및 `MCID`Adobe |
...
<table id="table_AECF59E131F84E7791A5A421BFB203FA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>SFTP 서버에 대한 SSH 키 인증에 대한 자세한 내용을 추가했습니다(5단계). </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>이 페이지에서는 아웃바운드 데이터 파일에서 원하는 ID 유형의 데이터를 내보낼 대상을 설정하는 방법을 보여줍니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe 고객은 Amazon S3 액세스 키와 비밀 키를 공유하지 않으려는 경우 아웃바운드 데이터 파일을 전달하기 위해 Amazon S3에서 계정 간 버킷 권한을 사용할 수 있습니다. 이 문서에서는 Audience Manager 관리 UI에서 이 대체 요소를 설정하는 방법을 보여 줍니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_81D2DA9293A9417085C630D00A7C96E1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">segmentId <code>매크로를</code> legacySegmentId로 <code>대체하고</code> newSegmentId <code>매크로를 추가했습니다</code> . </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"><a href="formats/enable-outbound-seq.md#concept_526744C9433F40BF8269E18245B2F0BD"> Hadoop 시퀀스 파일 전송을 아웃바운드 사용</a> </td> 
   <td colname="col2"> 고객이 아웃바운드 SEQ 파일을 자신의 Hadoop 인스턴스로 전송할 수 있도록 하는 방법을 확인하십시오. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_527E0E75C03846B0AB39EEE544904BE2"> 
      <li id="li_FC276B34158D44E3A5450C6C8BAF3184">전체 및 증분 동기화 사용의 균형을 조정하기 위한 지침을 추가했습니다. </li> 
      <li id="li_3975DA78DE9E441D8F8CB80F752DD7B7">Adobe Media Optimizer를 <span class="keyword"> Audience</span> Manager <span class="keyword"> 대상으로</span> 프로비저닝은 Adobe Media Optimizer에서 <span class="keyword"> 수행됩니다</span>. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="companies/admin-manage-company-destinations.md#manage-company-destinations"> 회사 대상 관리</a> </p> </td> 
   <td colname="col2"> <p>사소한 수정. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="companies/admin-device-graph-options.md#concept_563615F1018340C683E0EE075F8F639D"> 기업을 위한 장치 그래프 옵션</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>고객을 파악하고 고객에게 전달해야 하는 몇 가지 요구 사항과 권장 사항을 설명하는 새로운 문서입니다. 동일한 제목과 다른 읽기 대상의 변경 사항이 있는 공개 문서에 복제됩니다. 공개 <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-api-requirements.html" format="https" scope="external"> 문서에서 API 요구 사항 및</a> 권장 사항을 참조하십시오. </p> </td> 
  </tr> 
 </tbody> 
</table>

## AAM 파섹 {#aam-2016-docs-updates}
...
<table id="table_E9D9810EA8244B58A4F27D56CFE521FD"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">송신 FTP IP 52.44. <b>29.204를 추가했습니다</b>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="companies/admin-manage-company-destinations.md#manage-company-destinations"> 회사 대상 관리</a> </p> </td> 
   <td colname="col2"> <p>사소한 수정. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>서버 <b>구성 만들기</b> 마법사에 HTTP 서명을 추가했습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="companies/outbound-active-user-filter.md#task_F5CF8BDDA5DB4D23837B59CADF7A623B"> 활성 사용자만 기준으로 아웃바운드 데이터 필터링</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2" morerows="1"> <p>HTTP 매크로 및 일반적인 예를 나열하는 새 설명서입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="formats/web-format-examples.md#reference_98828E32B0964FF9AAC7C5400E88BA31"> HTTP 형식 매크로 예</a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_90F524BAAED44A45A1F6BF8BBA9F26F9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>수정된 매크로 섹션과 추가된 예입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_FA9962E19248418BA73D5A794A378C9D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>.info <span class="wintitle"> 영수증 </span>옵션에 대한 정보가 추가되었습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>라이프사이클 및 계정 <span class="wintitle"> 유형</span> 섹션에 추가 <span class="wintitle"> 정보가</span> 추가되었습니다. </p> </td> 
  </tr> 
  <tr> 
