...
+ 회사{#companies}
   ...
   + [기업을 위한 장치 그래프 옵션](companies/admin-device-graph-options.md)
   ...
   + [활성 사용자만 기준으로 아웃바운드 데이터 필터링](companies/outbound-active-user-filter.md)
+ 서버{#servers}
...
+ 보고{#reporting}
   ...
   + [타블로 사용자에게 포털 사용자 지정](admin-reporting/admin-assign-tableau-user.md)
+ 형식{#formats}
   + [포맷 개요](formats/formats.md)
   + [Hadoop 시퀀스 파일 전송을 아웃바운드 사용](formats/enable-outbound-seq.md)
   + [파일 형식 매크로](formats/file-formats.md)
   + [파일 형식 매크로 예](formats/file-format-examples.md)
   + [HTTP 형식 매크로](formats/web-formats.md)
   + [HTTP 형식 매크로 예](formats/web-format-examples.md)
