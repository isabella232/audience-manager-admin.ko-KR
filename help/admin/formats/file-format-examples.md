...
이러한 매크로는 모든 형식 필드에서 사용할 수 있습니다. 전체 목록 및 [정의는](../formats/file-formats.md) 파일 형식 매크로를 참조하십시오.
...
헤더 필드에만 사용되는 매크로입니다. 전체 목록 및 [정의는](../formats/file-formats.md) 파일 형식 매크로를 참조하십시오.
